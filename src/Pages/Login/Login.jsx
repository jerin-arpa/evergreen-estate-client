        ...
        <div>
            <div className="flex justify-center my-12 container mx-auto px-5 py-10">
                <div className="border rounded-xl w-full md:w-3/4 lg:w-2/4 py-8">
                    <h2 className="text-3xl font-bold text-center pt-10 pb-5"><span className="text-primary">Login</span> <span className="">your account</span></h2>
                    <form onSubmit={handleLogin} className="px-4 md:px-14">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn bg-primary border-primary hover:bg-white hover:text-primary text-white font-bold">Login</button>
                        </div>
                    ...
                    <div className="flex justify-center mb-4">
                        <h2 className="text-xs md:text-lg mt-6 md:mt-8 mb-6">Do not have an account? <Link to='/signup' className="text-primary underline font-bold">SignUp</Link></h2>
                    </div>
                </div>
            </div>
        </div>
